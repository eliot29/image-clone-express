...
const MethodeSection = () => {
 ...
 text-sm font-bold text-or-mat">{step.num}</span>
                  </div>
                  {i < steps.length - 1 &&
          ...
          <div className="text-center mt-6">
            <p className="font-dm text-sm text-ardoise/70 leading-relaxed max-w-md mx-auto">
              Les outils évoluent. Votre//
 activité aussi. Je reste disponible pour ajuster les solutions ou approfondir les usages.
            </p>
            <Button variant="ctaOutline" size="default" asChild className="mt-4">
              <Link to="/methode-semained54">
