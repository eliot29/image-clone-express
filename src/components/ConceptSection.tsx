          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 text-left">
            <div className="flex-1 bg-navy-clair/5 rounded-2xl p-6 border border-blanc-casse/10">
              <p className="font-dm text-blanc-casse/80 leading-relaxed mb-4">
                Les outils IA se multiplient. Beaucoup sont trop génériques<br className="sm:hidden" /> pour s'adapter à la réalité des entreprises. <strong className="text-blanc-casse font-bold">Le sujet : le contenu et la personnalisation.</strong>
              </p>
