...
const ConceptSection = () => {
  return (
    <section id="concept" className="bg-navy 
py-6">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl lg:max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch gap-6 
max-w-3xl mx-auto text-left">
            <div className="bg-blanc-casse/5 rounded-2xl p-6 border border-blanc-casse/10 flex-1">
              ...
              <p className="font-dm text-blanc-casse/80 leading-relaxed">
                <strong className="text-blanc-casse font-bold">Semaine 54 est un partenaire dédié aux TPE et PME 
bretonnes</strong>, pour des solutions d'intelligence artificielle construites sur mesure, autour de votre métier et de votre organisation.
              </p>
            </div>
            <img
              src="/__l5e/assets-v1/d963ce49-4717-4d63-bc8e-d5403d6ee4c5/villes-bretagne.png"
              alt="Villes desservies par Semaine 
54 
: Brest, Rennes, Saint-Brieuc et Vannes"
              className="w-full sm:w-[32%] self-center rounded-2xl object-cover"
            />
          </div>

          <p className="font-dm font-bold text-or-mat text-lg sm:text-xl mt-6 max-w-full 
mx-auto leading-snug text-center">
            L'IA est un avantage concurrentiel lorsqu'elle est adaptée à votre entreprise.
          </p>

          <div className="text-center mt-4">
            <Button variant="ctaOutline" size="default" 
asChild>
