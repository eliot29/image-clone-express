...
Sous certaines conditions.</span>
          ...
          <div className="bg-blanc-casse/5 rounded-2xl p-6 border border-blanc-casse/10 max-w-3xl mx-auto text-left">
            <p className="font-dm font-bold text-blanc-casse/80 leading-relaxed mb-4">Les outils IA se multiplient. Beaucoup sont trop génériques pour s'adapter à la réalité de votre entreprise. Le vrai sujet : l'accompagnement et la personnalisation.</p>
