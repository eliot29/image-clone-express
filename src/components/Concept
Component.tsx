...
import villesVisuel from "@/assets/villes-visuel.png;
            ...
            <div className="flex-1">
              <div className="bg-blanc-casse/5 rounded-2xl p-6 border border-blanc-casse/10">
                ...
                <p className="font-dm text-blanc-casse/80 leading-relaxed">
                  <strong className="text-blanc-casse bold">Semaine 54 est un partenaire dédié aux TPE et PME bretonnes</strong>, pour des solutions d'intelligence artificielle construites sur mesure, autour de votre métier et de votre organisation.
                </p>
              </div>
            </div>
