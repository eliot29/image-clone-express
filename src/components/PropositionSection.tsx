            ...
            <div className="inline-block bg-gris-perle rounded-2xl px-6 py-6 md:px-8 shadow-sm">
              ...
              <ul className="flex flex-wrap items-center gap-x-6 gap-y-3 justify-center">
                {comprehension.map((item, i) =>
                  <li key={i} className="flex items-center gap-3 font-dm font-bold text-base text-navy">
                    <div className="w-9 h-9 rounded-full bg-or-mat/10 flex items-center justify-center shrink-0">
...
<div className="rounded-2xl border-4 border-navy bg-blanc-casse px-4 py-5 sm:px-6 sm:py-6 mx-auto text-center">
            ...
            <p className="font-dm font-bold text-navy text-lg sm:text-xl lg:text-2xl leading-snug mt-2">
