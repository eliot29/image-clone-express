    ...
    <section id="contact" className="bg-navy py-10" style={{ scrollMarginTop: '120px' }}>
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="font-dm text-blanc-casse text-lg leading-relaxed mb-5 max-w-xl mx-auto">
            {intro}
          </p>
          ...
          {subIntro && <p className="font-dm text-blanc-casse/80 italic mb-4 max-w-xl mx-auto">{subIntro}</p>}

          <div className="space-y-3 mb-8 max-w-xl mx-auto">
            <p className="font-dm text-blanc-casse leading-relaxed">
          ...
          <p className="font-dm text-blanc-casse mb-6">
