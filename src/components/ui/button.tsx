...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-dm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        link: "text-primary underline-offset-4 hover:underline",
         cta: "cta-sweep bg-accent text-accent-foreground font-dm font-semibold rounded-[4px] shadow-cta hover:-translate-y-0.5 hover:shadow-lg",
