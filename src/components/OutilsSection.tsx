        ...
        <Reveal variant="card" className="relative overflow-hidden">
          ...
          <div className="flex gap-12 animate-marquee md:animate-marquee-slow hover:[animation-play-state:paused]">
            ...
            <div key={setIdx} className="flex gap-12 shrink-0 items-center">
              ...
              <span
                key={`${setIdx}-${tool}`}
                className="font-dm font-bold text-lg text-ardoise opacity-60 hover:opacity-100 hover:text-navy transition-opacity duration-150 ease-out whitespace-nowrap">
                    {tool}
                  </span>
              )}
              </div>
