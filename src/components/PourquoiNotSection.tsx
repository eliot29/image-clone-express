...
import { Eye, Users, TrendingUp, PhoneCall, Mic, FileText, Camera, SprayCan, Inbox } from "lucide-react";
...
border-or/40">
          ...
          <div className="grid gap-4 lg:grid-cols-2 lg:gap-6 mt-6">
            <Reveal delay={80} className="bg-navy rounded-xl 
p-5 
sm:p-6">
              <span className="font-semibold text-[11px] uppercase tracking-[0.18em] text-or">
                Résultats mesurés
...
mt-4">
                {resultats.map((r) => (
                  ...
                  >
                    ...
                    <div className="text-[11px] sm:text-xs text-blanc
-casse/70 
mt-1">
                      {r.label}
                    </div>
