            ...
            <div className="max-w-3xl lg:max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-navy/5 border border-navy/10 rounded-xl p-6">
                  ...
                  <p className="font-bold text-navy pt-2"><span className="text-or-mat">Un seul interlocuteur</span>, du diagnostic jusqu'au suivi.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl lg:max-w-4xl mx-auto">
              ...
              <div className="font-dm text-blanc-casse/85 leading-relaxed space-y-4">
                ...
                <h3 className="font-dm font-bold text-xl text-or-mat pt-2">Pragmatisme</h3>
                <p>
                ...
                <h3 className="font-dm font-bold text-xl text-or-mat pt-2">Autonomie</h3>
                <p>
                ...
                <h3 className="font-dm font-bold text-xl text-or-mat pt-2">Progressivité</h3>
                <Highlight variant="accent-dark">
                  <span className="text-or-mat">Pas de grand projet risqué.</span> On commence par un cas simple, on valide, puis on étend.
                </Highlight>
                <p>
